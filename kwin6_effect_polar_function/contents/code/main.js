...
//
// KWin 6 scripted window open/close effect: "Polar Function".
// Auto-generated port of the Niri custom-shader "polar-function".
...
class NiriPolarFunctionEffect {
    constructor() {
        ...
        this.shader = effect.addFragmentShader(Effect.MapTexture, "polar-function.frag");
    ...
    slotWindowAdded(window) {
        ...
        if (!NiriPolarFunctionEffect.shouldAnimateWindow(window)) return;
