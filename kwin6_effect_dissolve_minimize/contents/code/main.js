...
//
// KWin 6 scripted MINIMIZE/unminimize effect: "Dissolve Minimize".
// Auto-generated port of the Niri custom-shader "dissolve" (minimize role).
...
class NiriDissolveEffectMinimize {
    constructor() {
        effect.configChanged.connect(this.loadConfig.bind(this));
        this.shader = effect.addFragmentShader(Effect.MapTexture, "dissolve.frag");
        this.loadConfig();
    ...
    onMinimizedChanged(window) {
        ...
        if (!NiriDissolveEffectMinimize.shouldAnimateWindow(window)) {
            return;
        }
...
new NiriDissolveEffectMinimize();
