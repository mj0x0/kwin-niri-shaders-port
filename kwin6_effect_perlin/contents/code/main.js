...
//
// KWin 6 scripted window open/close effect: "Perlin".
// Auto-generated port of the Niri custom-shader "perlin".
...
class NiriPerlinEffect {
    constructor() {
        ...
        this.shader = effect.addFragmentShader(Effect.MapTexture, "perlin.frag");
    ...
    slotWindowAdded(window) {
        ...
        if (!NiriPerlinEffect.shouldAnimateWindow(window)) return;
