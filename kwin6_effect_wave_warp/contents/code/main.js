...
//
// KWin 6 scripted window open/close effect: "Wave Warp".
// Auto-generated port of the Niri custom-shader "wave-warp".
...
class NiriWaveWarpEffect {
    constructor() {
        ...
        this.shader = effect.addFragmentShader(Effect.MapTexture, "wave-warp.frag");
    ...
    slotWindowAdded(window) {
        ...
        if (!NiriWaveWarpEffect.shouldAnimateWindow(window)) return;
