...
//
// KWin 6 scripted MINIMIZE/unminimize effect: "Voronoi Shatter Minimize".
// Auto-generated port of the Niri custom-shader "voronoi-shatter" (minimize role).
...
class NiriVoronoiShatterEffectMinimize {
    constructor() {
        effect.configChanged.connect(this.loadConfig.bind(this));
        this.shader = effect.addFragmentShader(Effect.MapTexture, "voronoi-shatter.frag");
        this.loadConfig();
    ...
    onMinimizedChanged(window) {
        ...
        if (!NiriVoronoiShatterEffectMinimize.shouldAnimateWindow(window)) {
            return;
        }
...
new NiriVoronoiShatterEffectMinimize();
