...
//
// KWin 6 scripted window open/close effect: "Pixelfade Wave".
// Auto-generated port of the Niri custom-shader "pixelfade-wave".
...
class NiriPixelfadeWaveEffect {
    constructor() {
        ...
        this.shader = effect.addFragmentShader(Effect.MapTexture, "pixelfade-wave.frag");
    ...
    slotWindowAdded(window) {
        ...
        if (!NiriPixelfadeWaveEffect.shouldAnimateWindow(window)) return;
