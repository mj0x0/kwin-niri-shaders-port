...
//
// KWin 6 scripted MINIMIZE/unminimize effect: "Snap Minimize".
// Auto-generated port of the Niri custom-shader "snap" (minimize role).
...
class NiriSnapEffectMinimize {
    constructor() {
        effect.configChanged.connect(this.loadConfig.bind(this));
        this.shader = effect.addFragmentShader(Effect.MapTexture, "snap.frag");
        this.loadConfig();
    ...
    onMinimizedChanged(window) {
        ...
        if (!NiriSnapEffectMinimize.shouldAnimateWindow(window)) {
            return;
        }
