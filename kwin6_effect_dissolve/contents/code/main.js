...
//
// KWin 6 scripted window open/close effect: "Dissolve".
// Auto-generated port of the Niri custom-shader "dissolve".
...
class NiriDissolveEffect {
    ...
    slotWindowAdded(window) {
        ...
        if (!NiriDissolveEffect.shouldAnimateWindow(window)) return;
