...
//
// KWin 6 scripted window open/close effect: "Colour Distance".
// Auto-generated port of the Niri custom-shader "colour-distance".
...
class NiriColourDistanceEffect {
    constructor() {
        ...
        this.shader = effect.addFragmentShader(Effect.MapTexture, "colour-distance.frag");
    ...
    slotWindowAdded(window) {
        ...
        if (!NiriColourDistanceEffect.shouldAnimateWindow(window)) return;
