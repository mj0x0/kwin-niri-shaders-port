...
//
// KWin 6 scripted MINIMIZE/unminimize effect: "Bounce Minimize".
// Auto-generated port of the Niri custom-shader "bounce" (minimize role).
...
class NiriBounceEffectMinimize {
    constructor() {
        effect.configChanged.connect(this.loadConfig.bind(this));
        this.shader = effect.addFragmentShader(Effect.MapTexture, "bounce.frag");
        this.loadConfig();
    ...
    onMinimizedChanged(window) {
        ...
        if (!NiriBounceEffectMinimize.shouldAnimateWindow(window)) {
            return;
        }
