...
//
// KWin 6 scripted window open/close effect: "Fade".
// Auto-generated port of the Niri custom-shader "fade".
...
class NiriFadeEffect {
    constructor() {
        ...
        this.shader = effect.addFragmentShader(Effect.MapTexture, "fade.frag");
    ...
    slotWindowAdded(window) {
        ...
        if (!NiriFadeEffect.shouldAnimateWindow(window)) return;
