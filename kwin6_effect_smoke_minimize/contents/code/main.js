...
//
// KWin 6 scripted MINIMIZE/unminimize effect: "Smoke Minimize".
// Auto-generated port of the Niri custom-shader "smoke" (minimize role).
...
class NiriSmokeEffectMinimize {
    constructor() {
        effect.configChanged.connect(this.loadConfig.bind(this));
        this.shader = effect.addFragmentShader(Effect.MapTexture, "smoke.frag");
        this.loadConfig();
    ...
    onMinimizedChanged(window) {
        ...
        if (!NiriSmokeEffectMinimize.shouldAnimateWindow(window)) {
            return;
        }
