...
//
// KWin 6 scripted window open/close effect: "Circle".
// Auto-generated port of the Niri custom-shader "circle".
...
class NiriCircleEffect {
    ...
    slotWindowAdded(window) {
        ...
        if (!NiriCircleEffect.shouldAnimateWindow(window)) return;
