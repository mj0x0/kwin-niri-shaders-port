...
//
// KWin 6 scripted window open/close effect: "Heat Melt".
// Auto-generated port of the Niri custom-shader "heat-melt".
...
class NiriHeatMeltEffect {
    constructor() {
        ...
        this.shader = effect.addFragmentShader(Effect.MapTexture, "heat-melt.frag");
    ...
    slotWindowAdded(window) {
        ...
        if (!NiriHeatMeltEffect.shouldAnimateWindow(window)) return;
