...
//
// KWin 6 scripted window open/close effect: "Plasma Flow".
// Auto-generated port of the Niri custom-shader "plasma-flow".
...
class NiriPlasmaFlowEffect {
    constructor() {
        ...
        this.shader = effect.addFragmentShader(Effect.MapTexture, "plasma-flow.frag");
    ...
    slotWindowAdded(window) {
        ...
        if (!NiriPlasmaFlowEffect.shouldAnimateWindow(window)) return;
