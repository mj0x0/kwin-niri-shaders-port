...
//
// KWin 6 scripted window open/close effect: "Crosswarp".
// Auto-generated port of the Niri custom-shader "crosswarp".
...
class NiriCrosswarpEffect {
    constructor() {
        ...
        this.shader = effect.addFragmentShader(Effect.MapTexture, "crosswarp.frag");
    ...
    slotWindowAdded(window) {
        ...
        if (!NiriCrosswarpEffect.shouldAnimateWindow(window)) return;
