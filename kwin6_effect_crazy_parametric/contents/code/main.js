...
//
// KWin 6 scripted window open/close effect: "Crazy Parametric".
// Auto-generated port of the Niri custom-shader "crazy-parametric".
...
class NiriCrazyParametricEffect {
    constructor() {
        ...
        this.shader = effect.addFragmentShader(Effect.MapTexture, "crazy-parametric.frag");
    ...
    slotWindowAdded(window) {
        ...
        if (!NiriCrazyParametricEffect.shouldAnimateWindow(window)) return;
