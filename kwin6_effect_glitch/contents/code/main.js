...
//
// KWin 6 scripted window open/close effect: "Glitch".
// Auto-generated port of the Niri custom-shader "glitch".
...
class NiriGlitchEffect {
    constructor() {
        ...
        this.shader = effect.addFragmentShader(Effect.MapTexture, "glitch.frag");
    ...
    slotWindowAdded(window) {
        ...
        if (!NiriGlitchEffect.shouldAnimateWindow(window)) return;
