...
//
// KWin 6 scripted window open/close effect: "Polka Dots Curtain".
// Auto-generated port of the Niri custom-shader "polka-dots-curtain".
...
class NiriPolkaDotsCurtainEffect {
    constructor() {
        ...
        this.shader = effect.addFragmentShader(Effect.MapTexture, "polka-dots-curtain.frag");
    ...
    slotWindowAdded(window) {
        ...
        if (!NiriPolkaDotsCurtainEffect.shouldAnimateWindow(window)) return;
...
new NiriPolkaDotsCurtainEffect();
