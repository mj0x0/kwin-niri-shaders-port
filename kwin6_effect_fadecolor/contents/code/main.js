...
//
// KWin 6 scripted window open/close effect: "Fadecolor".
// Auto-generated port of the Niri custom-shader "fadecolor".
...
class NiriFadecolorEffect {
    constructor() {
        ...
        this.shader = effect.addFragmentShader(Effect.MapTexture, "fadecolor.frag");
    ...
    slotWindowAdded(window) {
        ...
        if (!NiriFadecolorEffect.shouldAnimateWindow(window)) return;
