...
//
// KWin 6 scripted window open/close effect: "Morph".
// Auto-generated port of the Niri custom-shader "morph".
...
class NiriMorphEffect {
    constructor() {
        ...
        this.shader = effect.addFragmentShader(Effect.MapTexture, "morph.frag");
    ...
    slotWindowAdded(window) {
        ...
        if (!NiriMorphEffect.shouldAnimateWindow(window)) return;
