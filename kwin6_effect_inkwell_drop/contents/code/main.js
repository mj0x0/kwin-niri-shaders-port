...
//
// KWin 6 scripted window open/close effect: "Inkwell Drop".
// Auto-generated port of the Niri custom-shader "inkwell-drop".
...
class NiriInkwellDropEffect {
    constructor() {
        ...
        this.shader = effect.addFragmentShader(Effect.MapTexture, "inkwell-drop.frag");

        this.loadConfig();
    }

    loadConfig() {
        this.duration = animationTime(effect.readConfig("Duration", 1500));
    }
    ...
    slotWindowAdded(window) {
        ...
        if (!NiriInkwellDropEffect.shouldAnimateWindow(window)) return;
