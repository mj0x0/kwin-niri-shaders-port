...
//
// KWin 6 scripted window open/close effect: "Voronoi Shatter".
// Auto-generated port of the Niri custom-shader "voronoi-shatter".
...
class NiriVoronoiShatterEffect {
    constructor() {
    ...
    slotWindowAdded(window) {
        ...
        if (!NiriVoronoiShatterEffect.shouldAnimateWindow(window)) return;
