...
//
// KWin 6 scripted window open/close effect: "Directional Wipe".
// Auto-generated port of the Niri custom-shader "directional-wipe".
...
class NiriDirectionalWipeEffect {
    constructor() {
    ...
    slotWindowAdded(window) {
        ...
        if (!NiriDirectionalWipeEffect.shouldAnimateWindow(window)) return;
