...
//
// KWin 6 scripted window open/close effect: "Pixelate".
// Auto-generated port of the Niri custom-shader "pixelate".
...
class NiriPixelateEffect {
    ...
    slotWindowAdded(window) {
        ...
        if (!NiriPixelateEffect.shouldAnimateWindow(window)) return;
