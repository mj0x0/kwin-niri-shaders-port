...
//
// KWin 6 scripted window open/close effect: "Smoke".
// Auto-generated port of the Niri custom-shader "smoke".
...
class NiriSmokeEffect {
    ...
    slotWindowAdded(window) {
        ...
        if (!NiriSmokeEffect.shouldAnimateWindow(window)) return;
