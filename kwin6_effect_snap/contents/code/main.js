...
//
// KWin 6 scripted window open/close effect: "Snap".
// Auto-generated port of the Niri custom-shader "snap".
...
class NiriSnapEffect {
    ...
    slotWindowAdded(window) {
        ...
        if (!NiriSnapEffect.shouldAnimateWindow(window)) return;
