...
//
// KWin 6 scripted MINIMIZE/unminimize effect: "Directional Minimize".
// Auto-generated port of the Niri custom-shader "directional" (minimize role).
...
class NiriDirectionalEffectMinimize {
    constructor() {
    ...
    onMinimizedChanged(window) {
        ...
        if (!NiriDirectionalEffectMinimize.shouldAnimateWindow(window)) {
            return;
        }
...
new NiriDirectionalEffectMinimize();
