...
//
// KWin 6 scripted window open/close effect: "Ink Splash".
// Auto-generated port of the Niri custom-shader "ink-splash".
...
class NiriInkSplashEffect {
    constructor() {
        ...
        this.shader = effect.addFragmentShader(Effect.MapTexture, "ink-splash.frag");
    ...
    slotWindowAdded(window) {
        ...
        if (!NiriInkSplashEffect.shouldAnimateWindow(window)) return;
