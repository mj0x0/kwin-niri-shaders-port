...
//
// KWin 6 scripted window open/close effect: "Bounce".
// Auto-generated port of the Niri custom-shader "bounce".
...
class NiriBounceEffect {
    ...
    slotWindowAdded(window) {
        ...
        if (!NiriBounceEffect.shouldAnimateWindow(window)) return;
