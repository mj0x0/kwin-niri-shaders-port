...
//
// KWin 6 scripted window open/close effect: "Flyeye".
// Auto-generated port of the Niri custom-shader "flyeye".
...
class NiriFlyeyeEffect {
    constructor() {
        ...
        this.shader = effect.addFragmentShader(Effect.MapTexture, "flyeye.frag");
    ...
    slotWindowAdded(window) {
        ...
        if (!NiriFlyeyeEffect.shouldAnimateWindow(window)) return;
