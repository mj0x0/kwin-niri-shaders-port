...
//
// KWin 6 scripted window open/close effect: "Crosshatch".
// Auto-generated port of the Niri custom-shader "crosshatch".
...
class NiriCrosshatchEffect {
    constructor() {
        ...
        this.shader = effect.addFragmentShader(Effect.MapTexture, "crosshatch.frag");
    ...
    slotWindowAdded(window) {
        ...
        if (!NiriCrosshatchEffect.shouldAnimateWindow(window)) return;
