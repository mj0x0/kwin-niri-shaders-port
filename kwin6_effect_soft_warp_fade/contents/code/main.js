...
//
// KWin 6 scripted window open/close effect: "Soft Warp Fade".
// Auto-generated port of the Niri custom-shader "soft-warp-fade".
...
class NiriSoftWarpFadeEffect {
    constructor() {
        ...
        this.shader = effect.addFragmentShader(Effect.MapTexture, "soft-warp-fade.frag");
    ...
    slotWindowAdded(window) {
        ...
        if (!NiriSoftWarpFadeEffect.shouldAnimateWindow(window)) return;
