...
//
// KWin 6 scripted window open/close effect: "Static Fade".
// Auto-generated port of the Niri custom-shader "static-fade".
...
class NiriStaticFadeEffect {
    constructor() {
        ...
        this.shader = effect.addFragmentShader(Effect.MapTexture, "static-fade.frag");
    ...
    slotWindowAdded(window) {
        ...
        if (!NiriStaticFadeEffect.shouldAnimateWindow(window)) return;
