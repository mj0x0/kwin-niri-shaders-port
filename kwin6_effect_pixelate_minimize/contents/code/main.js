...
//
// KWin 6 scripted MINIMIZE/unminimize effect: "Pixelate Minimize".
// Auto-generated port of the Niri custom-shader "pixelate" (minimize role).
...
class NiriPixelateEffectMinimize {
    constructor() {
        effect.configChanged.connect(this.loadConfig.bind(this));
        this.shader = effect.addFragmentShader(Effect.MapTexture, "pixelate.frag");
        this.loadConfig();
    ...
    onMinimizedChanged(window) {
        ...
        if (!NiriPixelateEffectMinimize.shouldAnimateWindow(window)) {
            return;
        }
...
new NiriPixelateEffectMinimize();
