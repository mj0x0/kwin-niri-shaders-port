...
//
// KWin 6 scripted window open/close effect: "Randomsquares".
// Auto-generated port of the Niri custom-shader "randomsquares".
...
class NiriRandomsquaresEffect {
    constructor() {
        ...
        this.shader = effect.addFragmentShader(Effect.MapTexture, "randomsquares.frag");
    ...
    slotWindowAdded(window) {
        ...
        if (!NiriRandomsquaresEffect.shouldAnimateWindow(window)) return;
