...
//
// KWin 6 scripted window open/close effect: "Overexposure".
// Auto-generated port of the Niri custom-shader "overexposure".
...
class NiriOverexposureEffect {
    constructor() {
        ...
        this.shader = effect.addFragmentShader(Effect.MapTexture, "overexposure.frag");
    ...
    slotWindowAdded(window) {
        ...
        if (!NiriOverexposureEffect.shouldAnimateWindow(window)) return;
